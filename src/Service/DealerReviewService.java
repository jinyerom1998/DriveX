...
public interface DealerReviewService 
{
	 ...
	 * @return Reply리스트를 리턴
	 */
	List<Reply> selectReplyByNum(int sessionNum);
	 ...
	 *   
	 */
	int findBySessionNum(int sessionNum);
